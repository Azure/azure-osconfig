...
apt_sources:
  ...
  - kitware:
    source: deb [arch=amd64] https://apt.kitware.com/ubuntu/ $RELEASE main
    key: |
      -----BEGIN PGP PUBLIC KEY BLOCK-----
...
runcmd:
  ...
  # Install GTest
  - git clone https://github.com/google/googletest --recursive -b release-1.10.0
  - cd googletest && cmake . -G Ninja && cmake --build . --target install
