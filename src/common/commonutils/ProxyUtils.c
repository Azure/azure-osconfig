    ...
    {
        {
            ...
            *proxyPort = portNumber;
            ...
            OsConfigLog(log, LoggingLevelDebug, "HTTP proxy username: %s (%d)", *proxyUsername, usernameLength);
            OsConfigLog(log, LoggingLevelDebug, "HTTP proxy password: %s (%d)", *proxyPassword, passwordLength);
