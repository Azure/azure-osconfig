...
const BASELINE_RULE g_rules = 
{
    ...
    { "Ensure that the SSH IgnoreRhosts is configured", "43945588-1bdc-495c-bac8-6a71a62d30aa", "EnsureSshBestPracticeIgnoreRhosts" },
    { "Ensure that the SSH LogLevel is configured", "31f1a912-1b98-42fd-8381-1e8d1033bfd1", "EnsureSshLogLevelIsSet" },
    { "Ensure that the SSH MaxAuthTries is configured", "e7708534-5d98-406f-83ae-1de835b2906e", "EnsureSshMaxAuthTriesIsSet" },
    { "Ensure that the allowed users for SSH access are configured", "dc8da71d-aeba-4c03-8835-36fe158e372a", "EnsureAllowUsersIsConfigured" },
    { "Ensure that the denied users for SSH are configured", "1DB7D147-3A75-4637-8CDC-C119E22D0206", "EnsureDenyUsersIsConfigured" },
    { "Ensure that the allowed groups for SSH are configured", "D9868B1F-0C8E-4ADB-889E-14E374874ECE", "EnsureAllowGroupsIsConfigured" },
    { "Ensure that the denied groups for SSH are configured", "F85C04A4-427B-4EE1-B988-C3FF7B4998CC", "EnsureDenyGroupsConfigured" },
    { "Ensure that the SSH HostBasedAuthentication is configured", "66511f6b-f690-43df-9654-642260699eec", "EnsureSshHostbasedAuthenticationIsDisabled" },
    { "Ensure that the SSH PermitRootLogin is configured", "16511f6b-f690-43df-9654-642260699eec", "EnsureSshPermitRootLoginIsDisabled" },
    { "Ensure that the SSH PermitEmptyPasswords is configured", "d50c3f39-264c-4cdc-b0ba-89de8a0f6828", "EnsureSshPermitEmptyPasswordsIsDisabled" },
    ...
    { "Ensure that the SSH LoginGraceTime is configured", "39aa5c2b-5b36-84a7-4022-570a53c86ff9", "EnsureSshLoginGraceTimeIsSet" },
    { "Ensure that only approved MAC algorithms are used", "483e8b0c-7572-8467-7e0c-26e1e9ce6359", "EnsureOnlyApprovedMacAlgorithmsAreUsed" },
    { "Ensure that the SSH warning banner is configured", "9e240540-5e0a-4b60-beb2-57421c65a0b9", "EnsureSshWarningBannerIsEnabled" },
    { "Ensure that the SSH PermitUserEnvironment is configured", "0e665978-91f4-45af-bb7b-e4090b600c8d", "EnsureUsersCannotSetSshEnvironmentOptions" },
    { "Ensure that appropriate ciphers are used for SSH", "b07d4c69-a1d9-4c22-a486-634ec3b8c380", "EnsureAppropriateCiphersForSsh" },
    { "Ensure that the SSH port is configured", "1310042D-193F-414A-A7E3-B2C4E89AA537", "EnsureSshPortIsConfigured" },
    { "Ensure nodev option set on /home partition", "a87f15ed-1115-a22d-6f43-17db97c91111", "EnsureNodevOptionOnHomePartition" },
    { "Ensure nodev option set on /tmp partition", "a87f15ed-1115-a22d-6f43-17db97c91161", "EnsureNodevOptionOnTmpPartition" },
    { "Ensure nodev option set on /var/tmp partition", "a87f15ed-1115-a22d-6f43-17db97c91181", "EnsureNodevOptionOnVarTmpPartition" },
    { "Ensure nosuid option set on /tmp partition", "a87f15ed-1115-a22d-6f43-17db97c91191", "EnsureNosuidOptionOnTmpPartition" },
    { "Ensure nosuid option set on /var/tmp partition", "a87f15ed-1115-a22d-6f43-17db97c91171", "EnsureNosuidOptionOnVarTmpPartition" },
    { "Ensure noexec option set on /var/tmp partition", "b97f15dd-8185-a12d-6f43-17db97c98477", "EnsureNoexecOptionOnVarTmpPartition" },
    { "Ensure noexec option set on /dev/shm partition", "11e6dc3b-0659-3dc8-7d12-8eb0bb6c0890", "EnsureNoexecOptionOnDevShmPartition" },
    { "Ensure automounting is disabled", "8cffbbca-3e5b-9af9-65fe-ff7b6316565d", "EnsureAutomountingDisabled" },
    { "Ensure mounting of USB storage devices is disabled", "acffbbca-3e5b-9aa9-65ee-ff7b6116565f", "EnsureMountingOfUsbStorageDevicesIsDisabled" },
    { "Ensure core dumps are restricted", "429123d4-7e7d-2737-6542-2e86b82c16a1", "EnsureCoreDumpsAreRestricted" },
    { "Ensure prelink is disabled", "cdee3703-321a-69c4-107f-e7b350a95e5a", "EnsurePrelinkIsDisabled" },
    { "Ensure permissions on /etc/motd are configured", "b08735e4-8565-0ab1-0fba-b15e31be98e4", "EnsurePermissionsOnEtcMotd" },
    { "Ensure permissions on /etc/issue are configured", "69032884-324a-3289-a171-b17a541f7adb", "EnsurePermissionsOnEtcIssue" },
    { "Ensure permissions on /etc/issue.net are configured", "9110c0c6-27f1-065e-140d-2672c1ad055b", "EnsurePermissionsOnEtcIssueNet" },
    { "Ensure the nodev option is enabled for all removable media", "5c7537f2-b90b-44a4-89c9-4fca5fd79ef7", "EnsureNodevOptionEnabledForAllRemovableMedia" },
    { "Ensure the noexec option is enabled for all removable media", "7976cc38-fddb-4913-9295-4fcac2e641c3", "EnsureNoexecOptionEnabledForAllRemovableMedia" },
    { "Ensure the nosuid option is enabled for all removable media", "cdc390c9-fb4a-47f6-90a7-4e1bd6d0e9e6", "EnsureNosuidOptionEnabledForAllRemovableMedia" },
    { "Ensure talk client is not installed", "5133422e-990f-971e-661d-ccfc913c1d2c", "EnsureTalkClientIsNotInstalled" },
    { "Ensure permissions on /etc/hosts.allow are configured", "1d498679-5780-6db3-14cc-6433011e0310", "EnsurePermissionsOnEtcHostsAllow" },
    { "Ensure permissions on /etc/hosts.deny are configured", "71d554b5-1436-9676-1966-939ded8d0a37", "EnsurePermissionsOnEtcHostsDeny" },
    { "Ensure default deny firewall policy is set", "eb6c608a-2316-41bd-aa00-604249e31f27", "EnsureDefaultDenyFirewallPolicyIsSet" },
    ...
    { "Ensure password creation requirements are configured", "b042fda5-55f6-17ba-78d5-1ba33a4709f5", "EnsurePasswordCreationRequirements" },
    { "Ensure lockout for failed password attempts is configured", "1895704d-a326-90ca-3795-3a1289e7482d", "EnsureLockoutForFailedPasswordAttempts" },
    { "Ensure the cramfs file system is disabled", "9967cbaf-44be-0dd1-92ab-d4f4034b2d28", "EnsureDisabledInstallationOfCramfsFileSystem" },
    { "Ensure the freevxfs file system is disabled", "4c066a3d-8eba-a210-3228-cff300039363", "EnsureDisabledInstallationOfFreevxfsFileSystem" },
    { "Ensure all users' home directories exist", "c07e6adc-93ab-1d40-2c6d-f3f16ca9561d", "EnsureAllUsersHomeDirectoriesExist" },
    { "Ensure users own their home directories", "54e255d1-038a-860b-48a2-3d1821e34661", "EnsureUsersOwnTheirHomeDirectories" },
    { "Ensure users' dot files aren't group or world writable", "086cb95b-5427-3ac0-9b98-c5c5b593579a", "EnsureUsersDotFilesArentGroupOrWorldWritable" },
    { "Ensure no users have .forward files", "d02297d2-9f49-5276-0a92-5ac1e42e243c", "EnsureNoUsersHaveDotForwardFiles" },
    { "Ensure no users have .netrc files", "c1b7767e-6c84-6a54-10b8-b9797a8d707a", "EnsureNoUsersHaveDotNetrcFiles" },
    { "Ensure no users have .rhosts files", "28884fab-89e2-2250-a057-6f35637b4848", "EnsureNoUsersHaveDotRhostsFiles" },
    { "Ensure all groups in /etc/passwd exist in /etc/group", "835a98f5-46da-5332-6b45-38df223e9d9a", "EnsureAllEtcPasswdGroupsExistInEtcGroup" },
    { "Ensure no duplicate UIDs exist", "df7fd9e2-0cd0-47c1-92b0-f3cab6e06869", "EnsureNoDuplicateUidsExist" },
    { "Ensure no duplicate GIDs exist", "70f3d785-1410-440f-6f6d-79b051039d21", "EnsureNoDuplicateGidsExist" },
    { "Ensure no duplicate user names exist", "017e0242-25b9-2c72-7ac6-d601086f5c8b", "EnsureNoDuplicateUserNamesExist" },
    { "Ensure no duplicate groups exist", "bc5844b6-7e40-4f2f-7e81-1cbd18885dae", "EnsureNoDuplicateGroupsExist" },
    { "Ensure shadow group is empty", "cbdc33fa-0f1c-0a90-7fe9-8ef1cf6643c2", "EnsureShadowGroupIsEmpty" },
    { "Ensure the hfs file system is disabled", "39595d95-88a4-78e2-6e0e-fbde7fd95eed", "EnsureDisabledInstallationOfHfsFileSystem" },
    { "Ensure the hfsplus file systems is disabled", "68fb9c92-1009-9e24-694e-3d996a5e09c5", "EnsureDisabledInstallationOfHfsplusFileSystem" },
    { "Ensure the jffs2 file systems is disabled", "859c7aa0-6eeb-6aac-6160-2fdead2537bf", "EnsureDisabledInstallationOfJffs2FileSystem" },
    ...
    { "Ensure file permissions on /etc/shadow are configured", "13dabe7c-02ea-09d2-1a97-42cc7ac94eaa", "EnsurePermissionsOnEtcShadow" },
    { "Ensure file permissions on /etc/shadow- are configured", "1e941132-a3a7-5ccb-1817-50551b65202e", "EnsurePermissionsOnEtcShadowDash" },
    { "Ensure file permissions on /etc/gshadow are configured", "0a7f2b28-8586-6cef-512e-a28f991d83cd", "EnsurePermissionsOnEtcGShadow" },
    { "Ensure file permissions on /etc/gshadow- are configured", "0fe59dec-472c-4b11-a221-36053a47afb6", "EnsurePermissionsOnEtcGShadowDash" },
    { "Ensure file permissions on /etc/passwd are configured", "ad534c97-1070-415c-9fc7-c92366d3fc30", "EnsurePermissionsOnEtcPasswd" },
    { "Ensure file permissions on /etc/group are configured", "c41a47e9-1ba0-4e72-9f43-4659a4bfed63", "EnsurePermissionsOnEtcGroup" },
    { "Ensure file permissions on /etc/passwd- are configured", "0c67cac0-1e99-8a8f-32e1-841d18b01a9a", "EnsurePermissionsOnEtcPasswdDash" },
    { "Ensure file permissions on /etc/group- are configured", "865ebb92-8e64-4e3a-aa9b-0290768aa8f1", "EnsurePermissionsOnEtcGroupDash" },
    { "Ensure that access to the root account via su is restricted to the 'root' group", "0c77cac0-1e99-8a8f-32e1-841d18b01a9a", "EnsureSuRestrictedToRootGroup" },
    { "Ensure the 'root' group exists, and contain all members who can su to root", "8cac0c32-1add-42b9-9300-5ccb9f91aab3", "EnsureRootGroupExists" },
    ...
    { "Ensure that randomized placement of virtual memory regions is enabled", "d790e942-efd3-42e6-a3a5-9eb1d651a588", "EnsureVirtualMemoryRandomizationIsEnabled" },
    { "Ensure that kernel support for the XD/NX processor feature is enabled", "49c89437-d116-4d84-a91d-0dd59daafa0d", "EnsureKernelSupportForCpuNx" },
    { "Ensure '.' does not appear in root's $PATH", "d66f8908-7b9f-77fc-18d4-af85197e0aeb", "EnsureDotDoesNotAppearInRootsPath" },
    ...
    { "Ensure all bootloaders have password protection enabled", "8a4f5ce8-41c4-710c-631e-fbc36a2fa53e", "EnsureAllBootloadersHavePasswordProtectionEnabled" },
    { "Ensure permissions on bootloader config are configured", "091f0150-80d1-0e2d-7353-8cdb77fc6aa1", "EnsurePermissionsOnBootloaderConfig" },
    { "Ensure authentication is required for single user mode", "13a48ca1-92bc-63a1-a4de-b984375fa332", "EnsureAuthenticationRequiredForSingleUserMode" },
    { "Ensure packet redirect sending is disabled", "5ea9d618-1af4-4e59-65be-ffac234872e9", "EnsurePacketRedirectSendingIsDisabled" },
    { "Ensure sending ICMP redirects is disabled for all interfaces", "a492f72a-6b79-8a9d-3b4f-3fface972ab7", "EnsureIcmpRedirectsIsDisabled" },
    { "Ensure accepting source routed packets is disabled for all interfaces", "4ecae4e6-a3e2-44f5-9985-ea2a21962450", "EnsureSourceRoutedPacketsIsDisabled" },
    { "Ensure the default setting for accepting source routed packets is disabled for network interfaces", "63613c25-8ae1-4792-9572-02bdc941febf", "EnsureAcceptingSourceRoutedPacketsIsDisabled" },
    { "Ensure ignoring bogus ICMP responses to broadcasts is enabled", "88acc143-2f76-4418-9aa9-d0d5f244ab5f", "EnsureIgnoringBogusIcmpBroadcastResponses" },
    { "Ensure ignoring ICMP echo requests (pings) sent to broadcast/multicast addresses is enabled", "f5a5926d-9c64-41fa-8220-5bc0f8213550", "EnsureIgnoringIcmpEchoPingsToMulticast" },
    ...
    { "Ensure performing source validation by reverse path is enabled for all interfaces", "177e6190-1026-49fb-a1f9-fd5b10302280", "EnsureReversePathSourceValidationIsEnabled" },
    { "Ensure TCP SYN cookies are enabled", "db6ca14e-26c5-48cd-a6b7-fc953861043c", "EnsureTcpSynCookiesAreEnabled" },
    ...
    { "Ensure all wireless interfaces are disabled", "8def2d0c-303a-4c0b-858c-319f80f7c814", "EnsureAllWirelessInterfacesAreDisabled" },
    ...
    { "Ensure logging is configured", "15ca11bf-034a-56d6-564f-2f857d1f96c6", "EnsureLoggingIsConfigured" },
    { "Ensure the syslog, rsyslog, or syslog-ng package is installed", "8720959b-c356-4eaa-bb4f-720fb8006183", "EnsureSyslogPackageIsInstalled" },
    { "Ensure the systemd-journald service persists log messages", "7b3aa0e4-0464-4a0e-a265-9a585c4f266e", "EnsureSystemdJournaldServicePersistsLogMessages" },
    { "Ensure a logging service is enabled", "4c4e42e2-4cd2-3eaf-147b-ea4f61164d3e", "EnsureALoggingServiceIsEnabled" },
    { "Ensure file permissions for all rsyslog log files are configured", "fcc86485-487a-4644-87a0-f29f1b1cd28b", "EnsureFilePermissionsForAllRsyslogLogFiles" },
    { "Ensure logger configuration files are restricted", "afd57de2-4365-9949-79f7-f8e92c198746", "EnsureLoggerConfigurationFilesAreRestricted" },
    ...
    { "Ensure all rsyslog log files are owned by the syslog user", "2830790c-5b3f-43cb-be6b-7572e441acc1", "EnsureAllRsyslogLogFilesAreOwnedBySyslogUser" },
    ...
    { "Ensure the logrotate (syslog rotater) service is enabled", "2d2355e7-7b07-4c0e-a395-16499c27ae94", "EnsureSyslogRotaterServiceIsEnabled" },
    { "Ensure the rlogin service is disabled", "f57ef648-bdaa-45a3-9e3a-f4649c48896f", "EnsureRloginServiceIsDisabled" },
    { "Ensure inetd is not installed", "a8a37e7f-9aae-41cf-8313-42d1f69506b9", "EnsureInetdNotInstalled" },
    { "Ensure xinetd is not installed", "1d9557b2-b58f-4f81-bde9-4f9b08a3b2f1", "EnsureXinetdNotInstalled" },
    { "Ensure the telnet service is disabled", "0617b91c-2a28-42bd-b5b3-7562555b41ed", "EnsureTelnetServiceIsDisabled" },
    ...
    { "Ensure the rsh-server package is uninstalled", "b256491f-f804-4c44-bfa4-057dd2f44c30", "EnsureRshServerNotInstalled" },
    ...
    { "Ensure the tftp service is disabled", "cb086aef-fec2-467f-a03b-627c00020926", "EnsureTftpServiceisDisabled" },
    { "Ensure the tftpd package is not installed", "ae9ce111-ef4d-4d34-8f76-fdc38263f153", "EnsureTftpdNotInstalled" },
    ...
    { "Ensure the cron service is enabled", "80302f61-d760-4165-a92b-a789e579380f", "EnsureCronServiceIsEnabled" },
    ...
    { "Ensure permissions on /etc/cron.d are configured", "efa30987-4c67-73f5-979f-cb50f79466de", "EnsurePermissionsOnEtcCronD" },
    { "Ensure permissions on  /etc/cron.daily are configured", "0cc35843-7687-60cf-5280-bb98cf9a87c2", "EnsurePermissionsOnEtcCronDaily" },
    { "Ensure permissions on  /etc/cron.hourly are configured", "ecdce8a2-9986-5833-8211-baf1938c1940", "EnsurePermissionsOnEtcCronHourly" },
    { "Ensure permissions on  /etc/cron.monthly are configured", "b5e94c1f-4d12-8bde-4c5e-98c651bd4430", "EnsurePermissionsOnEtcCronMonthly" },
    { "Ensure permissions on  /etc/cron.weekly are configured", "61417e01-8cc4-86ab-0e3b-867d42dea66d", "EnsurePermissionsOnEtcCronWeekly" },
    { "Ensure at/cron is restricted to authorized users", "7ac5f3c8-917b-548e-3138-c6e326a362fc", "EnsureAtCronIsRestrictedToAuthorizedUsers" },
    { "Ensure the remote login warning banner is properly configured", "d8bba1aa-69e9-2caf-1632-72938ff6759a", "EnsureRemoteLoginWarningBannerIsConfigured" },
    { "Ensure the local login warning banner is properly configured", "14c168de-4508-a69d-0feb-2f1efe245a71", "EnsureLocalLoginWarningBannerIsConfigured" },
    { "Ensure the avahi-daemon service is disabled", "c3bf78d8-43a0-4768-b790-c940621057b6", "EnsureAvahiDaemonServiceIsDisabled" },
    { "Ensure the cups service is disabled", "4854666c-061b-4945-8a25-19133b8d5c7d", "EnsureCupsServiceisDisabled" },
    { "Ensure the isc-dhcp-server package is not installed", "660fa012-ca99-4314-a2a8-11728020bac7", "EnsureIscDhcpdServerNotInstalled" },
    ...
    { "Ensure the ldap service is disabled and the sldapd package is not installed", "b577b358-6ec9-4ed7-b0df-259e44713b16", "EnsureSldapdNotInstalled" },
    ...
    { "Ensure the Network File System (NFS) service is disabled", "ee372ff3-9221-498b-b467-7406bf421168", "EnsureNetworkFileSystemServiceIsDisabled" },
    { "Ensure the rpcsvcgssd service is disabled", "78963287-11b9-471b-9122-e6829e105989", "EnsureRpcsvcgssdServiceIsDisabled" },
    { "Ensure the named service is disabled and the bind9 package is not installed", "361a6cb4-f761-426f-a9d0-9e82ec0b3285", "EnsureBind9NotInstalled" },
    ...
    { "Ensure no legacy + entries exist in /etc/passwd", "cc627f0c-3b72-6cc9-36b0-d2a3957431f4", "EnsureNoLegacyPlusEntriesInEtcPasswd" },
    { "Ensure no legacy + entries exist in /etc/shadow", "1a102d2e-76db-5ccf-3580-ccda064e8df3", "EnsureNoLegacyPlusEntriesInEtcShadow" },
    { "Ensure no legacy + entries exist in /etc/group", "b487e075-15b4-0df1-550f-d8d5edd78eb4", "EnsureNoLegacyPlusEntriesInEtcGroup" },
    { "Ensure password expiration is configured", "6ee7250d-142f-57db-25d0-c58207135059", "EnsurePasswordExpiration" },
    { "Ensure password expiration warning days is configured", "b7ac978f-0963-a61f-58ae-5cf84ab76b5d", "EnsurePasswordExpirationWarning" },
    { "Ensure password reuse is limited", "57bdeae2-863e-14fb-a463-d6ee64816b33", "EnsurePasswordReuseIsLimited" },
    { "Ensure the password hashing algorithm is SHA-512", "01ec5346-882b-485d-8960-01dedd608792", "EnsurePasswordHashingAlgorithm" },
    { "Ensure the minimum days between password changes is configured", "50272a84-672d-4c11-a67e-9d058adaf67a", "EnsureMinDaysBetweenPasswordChanges" },
    ...
    { "Ensure the inactive password lock period is configured", "91fbaeac-f5d0-4ac9-aa1b-52215aef1ed8", "EnsureInactivePasswordLockPeriod" },
    { "Ensure all system accounts are non-login", "448b668a-738c-420b-b332-51ea49922933", "EnsureSystemAccountsAreNonLogin" },
    { "Ensure default group for the root account is GID 0", "732fa92f-647e-47b8-b5a4-fdf00b02d9e2", "EnsureDefaultRootAccountGroupIsGidZero" },
    { "Ensure root is the only UID 0 account", "b5845ff3-42f4-4112-b2a2-5b827232a053", "EnsureRootIsOnlyUidZeroAccount" },
    ...
    { "Ensure the SNMP Server is not enabled", "ca1aea32-3969-49ab-abfc-2c5796a9a8bb", "EnsureSnmpServerIsDisabled" },
    { "Ensure the rsync service is not enabled", "63aba603-b1f8-40df-82c5-38915452ce23", "EnsureRsynServiceIsDisabled" },
    { "Ensure the NIS server is not enabled", "b4ad3fdd-7b68-4b11-a3ed-84b37a68b995", "EnsureNisServerIsDisabled" },
    { "Ensure the rsh client is not installed", "6d441f31-f888-4f4f-b1da-7cfc26263e3f", "EnsureRshClientNotInstalled" },
    { "Ensure SMB V1 with Samba is disabled", "7624efb0-3026-4c72-8920-48d5be78a50e", "EnsureSmbWithSambaIsDisabled" }
};
...
int AsbIsValidResourceIdRuleId(const char* resourceId, const char* ruleId, const char* payloadKey, void* log)
{
    ...
    for (i = 0; i < numRules; i++)
    {
        if (0 == strcmp(payloadKey, (g_rules[i]).payloadKey))
        {
            ...
            {
                OsConfigLogError(log, "AsbIsValidRuleIdAndName: resourceId for rule '%' of '%s' (instead of '%s') is invalid", payloadKey, resourceId, (g_rules[i]).resourceId);
                result = ENOENT;
            }
            else if (0 != strcmp(ruleId, (g_rules[i]).ruleId))
            {
                OsConfigLogError(log, "AsbIsValidRuleIdAndName: ruleId for rule '%' of '%s' (instead of '%s') is invalid", payloadKey, ruleId, (g_rules[i]).ruleId);
                result = ENOENT;
            }
            else
            {
