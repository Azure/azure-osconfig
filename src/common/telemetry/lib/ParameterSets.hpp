...
// CommandExecuted
const std::set<std::string> COMMAND_EXECUTED_REQUIRED_PARAMS = {"CorrelationGroup", "IsTestMode", "Subcommand", "Success", "Duration", "ErrorKind",
    "ErrorResourceName", "ErrorResourceType", "ErrorLocation", "ErrorCode"};
