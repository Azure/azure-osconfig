...
namespace E2eTesting
{
    ...
    public class HostNameTests : E2ETest
    {
        ...
        {
            HostName reported = GetReported<HostName>(_componentName, (HostName hostname) => (hostname.Name != null) && (hostname.Hosts != null));
        ...
        public void HostNameTest_Set()
        {
            ...
            SetDesired<DesiredHostName>(_componentName, desired);

            HostName reported = GetReported<HostName>(_componentName, (HostName hostname) => {
