...
{
    Evaluator evaluator(nullptr, mParameters, &mContext);
...
TEST_F(EvaluatorTest, ExecuteAudit_InvalidJSON_1)
{
    ...
    Evaluator evaluator(json_value_get_object(json.get()), mParameters, &mContext);
...
TEST_F(EvaluatorTest, ExecuteAudit_InvalidJSON_2)
{
    ...
    ASSERT_TRUE(json.get());
    Evaluator evaluator1(json_value_get_object(json.get()), mParameters, &mContext);
    ...
    ASSERT_TRUE(json.get());
    Evaluator evaluator2(json_value_get_object(json.get()), mParameters, &mContext);
