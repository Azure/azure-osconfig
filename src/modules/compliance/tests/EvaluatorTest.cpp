...
{
    auto evaluator = Evaluator(nullptr, {}, nullptr);
...
TEST_F(EvaluatorTest, ExecuteAuditInvalidArguments)
{
    ...
    auto evaluator = Evaluator(json_value_get_object(json.get()), {}, nullptr);
...
TEST_F(EvaluatorTest, ExecuteAudit_InvalidJSON_2)
{
    ...
    ASSERT_TRUE(json.get());
    auto evaluator1 = Evaluator(json_value_get_object(json.get()), {}, nullptr);
    char* payload = nullptr;
    int payloadSizeBytes = 0;
    ...
    ASSERT_TRUE(json.get());
    auto evaluator2 = Evaluator(json_value_get_object(json.get()), {}, nullptr);
