...
const std::string moduleName = "MultiComponentModule";
    ...
    int* payloadSizeBytes)
{
    ...
    if (0 == strcmp(componentName, componentName1.c_str()))
    {
        int sz = std::snprintf(nullptr, 0, fmt, componentName1.c_str(), moduleName.c_str());
        *payload = new char[sz + 1];
        std::snprintf(*payload, sz, fmt, componentName1.c_str(), moduleName.c_str());
        *payloadSizeBytes = sz;
    }
    else if (0 == strcmp(componentName, componentName2.c_str()))
    {
