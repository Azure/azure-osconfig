...
const std::string moduleName = "MultiComponentLargerVersionModule";
// "TestComponent2" are defined in MultiComponentModule, newer version (this module), and newest version.
    ...
    int* payloadSizeBytes)
{
    ...
    constexpr const char ret[] = R""""({
        "Name": "MultiComponentLargerVersionModule",
