...
using ComplianceEngine::AuditIp6tablesOpenPorts;
using ComplianceEngine::AuditIptablesOpenPorts;
using ComplianceEngine::AuditUfwOpenPorts;
...
TEST_F(EnsureFirewallOpenPortsTest, IptablesOpenPorts_GetOpenPortsFails_ReturnsError)
{
    ...
    auto result = AuditIptablesOpenPorts(indicators, mockContext);
...
TEST_F(EnsureFirewallOpenPortsTest, Ip6tablesOpenPorts_GetOpenPortsFails_ReturnsError)
{
    ...
    auto result = AuditIp6tablesOpenPorts(indicators, mockContext);
...
TEST_F(EnsureFirewallOpenPortsTest, UfwOpenPorts_GetOpenPortsFails_ReturnsError)
{
    ...
    auto result = AuditUfwOpenPorts(indicators, mockContext);
