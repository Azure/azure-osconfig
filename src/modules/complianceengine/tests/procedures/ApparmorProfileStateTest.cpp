...
using ComplianceEngine::ApparmorProfileStateParams;
using ComplianceEngine::AuditApparmorProfileState;
...
TEST_F(EnsureApparmorProfilesTest, AuditApparmorStatusCommandFails)
{
    ...
    ApparmorProfileStateParams params;

    auto result = AuditApparmorProfileState(params, indicators, mContext);
