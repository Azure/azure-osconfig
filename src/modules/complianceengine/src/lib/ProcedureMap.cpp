...
// EnsureSshdOption.h:19
const char* Bindings<EnsureSshdOptionParams>::names[] = {"option", "value"};

// EnsureSshdOption.h:30
const char* Bindings<EnsureSshdNoOptionParams>::names[] = {"options", "values"};
...
const ProcedureMap Evaluator::mProcedureMap = {
    ...
    {"EnsureSshdNoOption", {MakeHandler(AuditEnsureSshdNoOption), nullptr}},
