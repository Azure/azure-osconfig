...
#ifndef COMPLIANCEENGINE_PROCEDURES_LOG_FILE_PERMISSIONS_H
#define COMPLIANCEENGINE_PROCEDURES_LOG_FILE_PERMISSIONS_H
...
#endif // COMPLIANCEENGINE_PROCEDURES_LOG_FILE_PERMISSIONS_H
