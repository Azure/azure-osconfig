...
#ifndef COMPLIANCEENGINE_PROCEDURES_NETWORK_INTERFACE_FLAG_H
#define COMPLIANCEENGINE_PROCEDURES_NETWORK_INTERFACE_FLAG_H
...
#endif // COMPLIANCEENGINE_PROCEDURES_NETWORK_INTERFACE_FLAG_H
