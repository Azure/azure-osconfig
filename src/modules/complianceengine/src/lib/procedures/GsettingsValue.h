...
#ifndef COMPLIANCEENGINE_PROCEDURES_GSETTINGS_VALUE_H
#define COMPLIANCEENGINE_PROCEDURES_GSETTINGS_VALUE_H
...
#endif // COMPLIANCEENGINE_PROCEDURES_GSETTINGS_VALUE_H
