...
{
    return CheckMinDaysBetweenPasswordChanges(/*7*/0, SecurityBaselineGetLog());  //TODO: fix this
}
...
{
    return CheckPasswordExpiration(/*365*/99999, SecurityBaselineGetLog()); //TODO: fix this
}
