...
static int AuditEnsureTheCrondServiceIsEnabled(void) //TODO: is cron, not crond
{
    return (0 == CheckPackageInstalled("cron", SecurityBaselineGetLog()) && 
        IsDaemonActive("cron.service", SecurityBaselineGetLog())) ? 0 : ENOENT;
}
