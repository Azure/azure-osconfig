...
static char* g_productName = "productName";
static char* g_productVendor = "productVendor";
static char* g_productVersion = "productVersion";
static char* g_systemCapabilities = "productCapabilities";
static char* g_systemConfiguration = "productConfiguration";
