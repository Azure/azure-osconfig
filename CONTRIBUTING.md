...
2. Fork the public GitHub repo: [https://github.com/microsoft/kompli.git](https://github.com/microsoft/kompli). [Learn more about forking a repo](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo).
